...
public class IntegrationTest_BackingBeanMapping_Converter_WrongSourceCollectionValue {
    ...
    public static class MySingleValueConverter implements FluentApiConverter<Long, String> {
        @Override
        public String convert(String aLong) {
            // ignore null safety..
            return aLong.toString();
        }
    }

    public static class MyArrayValueConverter implements FluentApiConverter<Long[], String[]> {
        @Override
    ...
    public static class MyCollectionValueConverter implements FluentApiConverter<List<String>, List<String>> {
        @Override
        public List<String> convert(List<String> aLong) {
            // ignore null safety..
            return null;
        }
    }
