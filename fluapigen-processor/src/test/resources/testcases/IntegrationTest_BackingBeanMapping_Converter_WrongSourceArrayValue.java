...
public class IntegrationTest_BackingBeanMapping_Converter_WrongSourceArrayValue {
    ...
    public static class MyArrayValueConverter implements FluentApiConverter<String[], String[]> {
        @Override
