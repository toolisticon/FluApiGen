...
public class IntegrationTest_BackingBeanMapping_Converter_WrongTargetCollectionValue {
    ...
    public static class MyCollectionValueConverter implements FluentApiConverter<List<Long>, List<Long>> {
        @Override
        public List<Long> convert(List<Long> aLong) {
            // ignore null safety..
            return null;
        }
    }
