...
public class IntegrationTest_BackingBeanMapping_Converter_WrongTargetSingleValue {
    ...
    public static class MySingleValueConverter implements FluentApiConverter<Long, Long> {
        @Override
