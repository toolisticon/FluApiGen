...
public class IntegrationTest_ImplicitValueConverterTest_withInvalidConverter_invalidTargetType {
    ...
    public static class MyConverter implements FluentApiConverter<String,String> {
