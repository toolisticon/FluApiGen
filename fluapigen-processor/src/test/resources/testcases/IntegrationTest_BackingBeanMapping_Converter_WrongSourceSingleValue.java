...
public class IntegrationTest_BackingBeanMapping_Converter_WrongSourceSingleValue {
    ...
    public static class MySingleValueConverter implements FluentApiConverter<String, String> {
        @Override
